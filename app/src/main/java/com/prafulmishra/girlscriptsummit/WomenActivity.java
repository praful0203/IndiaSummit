...
import com.prafulmishra.girlscriptsummit.data.WomenInTech;
...
Button btnApply;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.prafulmishra.girlscriptsummit.R.layout.activity_women);
        ...
        rtTechskills = (RatingBar)findViewById(com.prafulmishra.girlscriptsummit.R.id.rtTechskills);

        txtName = (EditText) findViewById(com.prafulmishra.girlscriptsummit.R.id.txtName);
        ...
        txtOtherskill = (EditText) findViewById(com.prafulmishra.girlscriptsummit.R.id.txtOtherskill);
        txtWomenintech = (EditText) findViewById(com.prafulmishra.girlscriptsummit.R.id.txtWomenintech);
        ...
        rdGroupHtml = (RadioGroup)findViewById(com.prafulmishra.girlscriptsummit.R.id.rgHtml);
        rdGroupdates = (RadioGroup)findViewById(com.prafulmishra.girlscriptsummit.R.id.rgdates);
        rdGroupPractice = (RadioGroup)findViewById(com.prafulmishra.girlscriptsummit.R.id.rgPractice);
        rdGroupStipend = (RadioGroup)findViewById(com.prafulmishra.girlscriptsummit.R.id.rgStipend);
        ...
        btnApply = (Button)findViewById(com.prafulmishra.girlscriptsummit.R.id.btnApplywomen);
    ...
    private void showInfo() {
        ...
        alertDialog.setMessage(getString(com.prafulmishra.girlscriptsummit.R.string.women_info));
