    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                subject = (EditText)findViewById(R.id.contactSub);
                message = (EditText)findViewById(R.id.contactMsg);
            ...
            /* Send it off to the Activity-Chooser */
                    ...
                    Toast.makeText(ContactUs.this, R.string.select_gmail, Toast.LENGTH_SHORT).show();
